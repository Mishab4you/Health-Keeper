...
<path d="M8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0zm0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13zm8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5zM3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8zm10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0zm-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0zm9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707zM4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708z"/>
    ...
    <div class="sidenav-wrapper" id="sidenavWrapper">
      ...
      <div class="sidenav-profile">
        ...
        <!-- User Info-->
        <div class="user-info">
          <h6 class="user-name mb-0"><?php $query=mysqli_query($con,"select fullName from users where id='".$_SESSION['id']."'");
while($row=mysqli_fetch_array($query)) { echo $row['fullName']; } ?></h6><span></span>
        </div>
      </div>
      <!-- Sidenav Nav-->
          ...
          <div class="card-body">
            <div class=" align-items-center">
              <div class="service-text">
                <h5>Welcome <?php $query=mysqli_query($con,"select fullName from users where id='".$_SESSION['id']."'");
while($row=mysqli_fetch_array($query)) { echo $row['fullName']; } ?></h5>
                <p class="mb-2">LOGIN SECTION</p>
                <div class="direction-rtl"><a class="btn m-1  btn-primary  btn-lg" href="edit-profile.php">My Profile</a><a class="btn m-1   btn-info  btn-lg" href="manage-medhistory.php">My Medical History</a>
                <!-- <a class="btn m-1   btn-danger  btn-lg" href="manage-medhistory.php">My Notes</a> -->
              </div>
              </div>
