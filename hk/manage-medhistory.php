...
$ret=mysqli_query($con,"select * from tblmedicalhistory where PatientID='".$_SESSION['id']."' ORDER BY id DESC");
...
<tr>
  ...
  <td><a href="#" onclick="window.print()" class="btn btn-primary">Print</a></td>
