...
{
$ret=mysqli_query($con,"SELECT * FROM users WHERE fullName='".$_POST['username']."' and password='".md5($_POST['password'])."'");
      ...
      <div class="row justify-content-center">
        <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
          ...
          <div class="register-form mt-4 px-4">
            <h6 class="mb-3 text-center">Log in to continue to Health Keeper.</h6>
          ...
          <div class="login-meta-data text-center">
            <!-- <a class="stretched-link forgot-password d-block mt-3 mb-1"  href="page-forget-password.html">Forgot Password?</a> --><br>
            <p class="mb-0">Didn't have an account? <a class="stretched-link" href="register.php">Register Now</a>
            </p>
          </div>
        </div>
      </div>
