...
$sql=mysqli_query($con,"insert into hospitals(hName,address,contactno,docEmail,password) values('$docname','$docaddress','$doccontactno','$docemail','$password')");
if($sql)
{
echo "<script>alert('Hospital info added Successfully');</script>";
										...
										<div class="col-lg-12 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading"><br>
													<h5 class="panel-title">Add Hospital</h5><br>
												</div>
...
<div class="form-group">
					...
					<input type="text" name="docname" class="form-control"  placeholder="Enter Hospital Name" required="true">
														</div>
...
<div class="form-group">
					...
					<textarea name="clinicaddress" class="form-control"  placeholder="Enter Hospital Address" required="true"></textarea>
														</div>
<!-- <div class="form-group">
															<label for="fess">
...
<div class="form-group">
					...
					<input type="text" name="doccontact" class="form-control"  placeholder="Enter Hospital Contact no" required="true">
														</div>
...
<input type="email" id="docemail" name="docemail" class="form-control"  placeholder="Enter Hospital Email id" required="true" onBlur="checkemailAvailability()">
...
<div class="form-group">
									...
									<input type="password" name="cfpass" class="form-control"  placeholder="Confirm Password" required="required">
														...
														<button type="submit" name="submit" id="submit" class="btn btn-o btn-primary w-100">
															Submit
														</button><br>
													</form><br>
												</div>
