...
$sql=mysqli_query($con,"Update hospitals set hName='$docname',address='$docaddress',contactno='$doccontactno',docEmail='$docemail' where id='$did'");
if($sql)
{
										...
										<div class="col-lg-12 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<center><h5 class="panel-title">Edit Hospital info</h5></center>
												</div>
												<div class="panel-body">
									<?php $sql=mysqli_query($con,"select * from hospitals where id='$did'");
