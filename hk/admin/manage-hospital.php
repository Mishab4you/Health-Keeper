...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from hospitals where id = '".$_GET['id']."'");
...
<div class="container">
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Hospital</span></h5>
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
                        <th class="hidden-xs">Hospital Name</th>
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select * from hospitals");
$cnt=1;
...
?>
											...
											<tr>
												...
												<td class="hidden-xs"><?php echo $row['hName'];?></td>
							...
							<a href="edit-hospital.php?id=<?php echo $row['id'];?>" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
													
	<a href="manage-hospital.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
												</div>
