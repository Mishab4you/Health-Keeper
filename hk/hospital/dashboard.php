    ...
    <div class="header-area" id="headerArea">
      <div class="container-lg">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          <!-- Logo Wrapper-->
          <div class="logo-wrapper"><a href="dashboard.php"><h5><b>Health Keeper (Hospital)</b></h5></a></div>
          <!-- Navbar Toggler-->
          ...
          <div class="card-body">
            <div class=" align-items-center">
              <div class="service-text">
                <h5>Welcome <?php $query=mysqli_query($con,"select hName from hospitals where id='".$_SESSION['id']."'");
while($row=mysqli_fetch_array($query)) { echo $row['hName']; } ?></h5>
                <p class="mb-2"></p>
                <div class="direction-rtl"><a class="btn m-1  btn-primary  btn-lg" href="edit-profile.php">My Profile</a><a class="btn m-1   btn-danger  btn-lg" href="logout.php">Logout</a></div>
              </div>
          ...
          <div class="card-body">
            <div class=" align-items-center">
              <div class="service-text">
                <h5>Patients</h5>
                <p class="mb-2"></p>
                <div class="direction-rtl"><a class="btn m-1  btn-dark  btn-lg" href="manage-patient.php">Patients List</a>
