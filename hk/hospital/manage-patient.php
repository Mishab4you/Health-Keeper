...
<td class="hidden-xs"><strong><?php echo $row['id'];?></strong></td>
<td class="hidden-xs"><strong><?php echo $row['fullName'];?></strong></td>
<td><?php echo $row['address'];?></td>
<td><?php echo $row['gender'];?></td>
</td>
<td>
 <a class="btn btn-primary" href="view-patient.php?viewid=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a>
