...
$sql=mysqli_query($con,"Update hospitals set hName='$docname',address='$docaddress' contactno='$doccontactno' where id='".$_SESSION['id']."'");
if($sql)
{
  ...
  <body>
    ...
    <div class="header-area" id="headerArea">
      <div class="container">
		...
		<div class="back-button"><a href="dashboard.php"><svg width="32" height="32" viewBox="0 0 16 16" class="bi bi-arrow-left-short" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<div class="page-content-wrapper py-3">
     ...
     <div class="card">
	  ...
	  <h5 class="">Edit Hospital</h5>
												<div class="panel-body">
									<?php $sql=mysqli_query($con,"select * from hospitals where hName='".$_SESSION['dlogin']."'");
while($data=mysqli_fetch_array($sql))
{
?>
<h4><?php echo htmlentities($data['hName']);?>'s Profile</h4>
<p><b><font color="red">Profile Reg. Date: </b><?php echo htmlentities($data['creationDate']);?></font></p>
...
<div class="form-group">
	...
	<input type="text" name="docname" class="form-control" value="<?php echo htmlentities($data['hName']);?>" >
														</div>
...
<div class="form-group">
                  ...
                  Hospital Email
					...
					<input type="email" name="docemail" class="form-control"  readonly="readonly"  value="<?php echo htmlentities($data['docEmail']);?>">
														...
														<button type="submit" name="submit" class="btn btn-o btn-primary w-100">
															Update
														</button>
													</form>
